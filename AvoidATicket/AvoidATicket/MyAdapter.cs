...
{
    public class MyAdapter : BaseAdapter<BusStops>
    {
        List<BusStops> items;
        Activity context;
        public MyAdapter(Activity context, List<BusStops> items)
            : base()
        {
        ...
        public override BusStops this[int position]
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            view.FindViewById<TextView>(Android.Resource.Id.Text2).Text = item.Direction;
